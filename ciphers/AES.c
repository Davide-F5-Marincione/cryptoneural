//source code from https://github.com/m3y54m/aes-in-c/tree/main/src and modifed to be adapted to the actual problem
#include "AES.h"
...
void aes_main(unsigned char *state, unsigned char *expandedKey, int nbrRounds, int effectiveRounds);
// Implementation: AES encryption
char aes_encrypt(unsigned char *input, unsigned char *output, unsigned char *key, int keySize,  int effectiveRounds);
...
int main(int argc, char *argv[])
{
    ...
    // AES Encryption
    aes_encrypt(plaintext, ciphertext, key, 16, 2);
                  ...
                  int effectiveRounds)
{
    ...
    else
    {
        ...
        aes_main(block, expandedKey, nbrRounds, effectiveRounds);
